label scene2:
    ...
    voice "C-2-15.mp3" #Bartender (Andrew Boa)
    ten "Another?"

    "I might be staying here longer than I thought."

    voice "C-2-16.mp3" #Wayfarer (Terrance Drye)
    wan "Just one."
    ...
    voice "C-2-29.mp3" #Wayfarer (Terrance Drye)
    wan "She's good."

    voice "C-2-30.mp3" #Bartender (Andrew Boa)
    ...
    voice "C-2-31.mp3" #Wayfarer (Terrance Drye)
    wan "You let people talk to her after her sets?"

    "He seems incredibly unsurprised."

    voice "C-2-32.mp3" #Bartender (Andrew Boa)
    ...
    voice "C-2-33.mp3" #Wayfarer (Terrance Drye)
    wan "Why's that?"

    voice "C-2-34.mp3" #Bartender (Andrew Boa)
    ...
    voice "C-2-35.mp3" #Wayfarer (Terrance Drye)
    wan "What, a bar singer who's too shy to talk to people?"

    voice "C-2-36.mp3" #Bartender (Andrew Boa)
    ten "In the flesh."
    ...
    voice "C-2-37.mp3" #Wayfarer (Terrance Drye)
    wan "I think I'll take my chances."

    voice "C-2-38.mp3" #Bartender (Andrew Boa)
    ten "You tread a dangerous path."

    "Then he nodded at something behind me."

    voice "C-2-39.mp3" #Bartender (Andrew Boa)
    ...
    voice "C-2-40.mp3" #Bartender (Andrew Boa)
